...
const PhotoPreview = () => {
    ...
    return (
            ...
            <div
                className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-christian-accent/10 to-hindu-secondary/10 p-4">
                <motion.div
                    ...
                    <div className={`p-${isTablet ? '4' : '6'} ${isLandscape ? 'flex items-center' : 'block'}`}>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <div
                                    className="aspect-[1.414/1] w-full overflow-hidden rounded-lg shadow-lg relative mb-2">
